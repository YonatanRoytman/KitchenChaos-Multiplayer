...
public class OptionsUI : MonoBehaviour
{
    ...
    [SerializeField] private Transform pressToRibindKeyTransform;
    ...
    {
        pressToRibindKeyTransform.gameObject.SetActive(true);
    }
    private void HidePressToRebindKey()
    {
        pressToRibindKeyTransform.gameObject.SetActive(false);
    }
